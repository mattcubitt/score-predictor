        ...
        return (
            ...
            <div className="about" style={{marginTop: '50px'}}>
                ...
                <div className="row">
                    ...
                    <div className="col-md-4 text-xs-center">
                        <img className="team-member" src="/assets/images/team/matt.png" alt="Matt"/>
                        <h4>Matt</h4>
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="https://facebook.github.io/react/">
                                <img className="card-img-top" src="/assets/images/tech/react.png" alt="React"/>
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="http://redux.js.org/">
                                <img className="card-img-top" src="/assets/images/tech/redux.png" alt="Redux"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="https://nodejs.org/en/">
                                <img className="card-img-top image-fix" src="/assets/images/tech/nodejs.png" alt="Node"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="http://koajs.com/">
                                <img className="card-img-top" src="/assets/images/tech/koa.png" alt="koa"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="https://www.mongodb.com/">
                                <img className="card-img-top" src="/assets/images/tech/mongodb.png" alt="mongodb"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="https://www.heroku.com/home">
                                <img className="card-img-top" src="/assets/images/tech/heroku.png" alt="Heroku"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="https://webpack.github.io/">
                                <img className="card-img-top image-fix" src="/assets/images/tech/webpack.png" alt="Webpack"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="https://babeljs.io/">
                                <img className="card-img-top" src="/assets/images/tech/babel.png" alt="Babel"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="http://v4-alpha.getbootstrap.com/">
                                <img className="card-img-top" src="/assets/images/tech/bootstrap.png" alt="Axure"/>
                                <div className="card-block">
                    ...
                    <div className="col-md-3">
                        <div className="card">
                            <a target="_blank" href="http://www.axure.com/">
                                <img className="card-img-top" src="/assets/images/tech/axure.png" alt="Axure"/>
                                <div className="card-block">
