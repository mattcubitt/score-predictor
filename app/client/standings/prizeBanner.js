                ...
                <div className="prize-container">
                    <div className="row">
                        <div className="col-xs-12 col-md-3 prize-item">
                            ...
                            <div className="prize-description">The MI Euro 2016 champion wins an iPad mini (or equivalent in amazon or john lewis vouchers)</div>
                        </div>
                        <div className="col-xs-12 col-md-3 prize-item">
                            <div className="prize-icon"><img src="assets/images/headphones.png" alt="2nd Place"/></div>
                            <div className="prize-title">2nd Place</div>
                            <div className="prize-description">The runner up wins a pair of Beats headphones (or equivalent in amazon or john lewis vouchers)</div>
                        </div>
                        <div className="col-xs-12 col-md-3 prize-item">
